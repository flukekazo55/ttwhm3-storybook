...
@Component({
  selector: 'app-lizardmen',
  templateUrl: './lizardmen.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './lizardmen.component.scss',
  ],
})
export class LizardmenComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Lizardmen คือใคร?' },
