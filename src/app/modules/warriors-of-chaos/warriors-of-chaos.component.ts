...
@Component({
  selector: 'app-warriors-of-chaos',
  templateUrl: './warriors-of-chaos.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './warriors-of-chaos.component.scss',
  ],
})
export class WarriorsOfChaosComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Warriors Of Chaos คือใคร?' },
