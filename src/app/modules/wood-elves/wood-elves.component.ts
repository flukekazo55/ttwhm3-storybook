...
@Component({
  selector: 'app-wood-elves',
  templateUrl: './wood-elves.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './wood-elves.component.scss',
  ],
})
export class WoodElvesComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Wood Elves คือใคร?' },
