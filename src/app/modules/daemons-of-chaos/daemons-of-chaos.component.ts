...
@Component({
  selector: 'app-daemons-of-chaos',
  templateUrl: './daemons-of-chaos.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './daemons-of-chaos.component.scss',
  ],
})
export class DaemonsOfChaosComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Daemons Of Chaos คือใคร?' },
