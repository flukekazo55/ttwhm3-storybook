...
@Component({
  selector: 'app-vampire-coast',
  templateUrl: './vampire-coast.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './vampire-coast.component.scss',
  ],
})
export class VampireCoastComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Vampire Coast คือใคร?' },
