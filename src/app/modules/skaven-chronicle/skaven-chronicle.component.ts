...
@Component({
  selector: 'app-skaven-chronicle',
  templateUrl: './skaven-chronicle.component.html',
  styleUrls: [
    '../chronicle/chronicle.component.scss',
    './skaven-chronicle.component.scss',
  ],
})
export class SkavenChronicleComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Skaven คือใคร?' },
    { id: 'ch2', numeral: 'II', title: 'Skavenblight และ Under-Empire' },
    { id: 'ch3', numeral: 'III', title: 'Horned Rat และ Council of Thirteen' },
    { id: 'ch4', numeral: 'IV', title: 'Four Great Clans' },
    { id: 'ch5', numeral: 'V', title: 'Legendary Lords' },
    { id: 'ch6', numeral: 'VI', title: 'Warpstone, อาวุธ และการทดลอง' },
    { id: 'ch7', numeral: 'VII', title: 'Food, Under-Cities และ Menace Below' },
    { id: 'ch8', numeral: 'VIII', title: 'กองทัพ Skaven' },
    { id: 'ch9', numeral: 'IX', title: 'เล่น Skaven ใน WARHAMMER III' },
    { id: 'sources', numeral: 'X', title: 'Thanquol, End Times และแหล่งอ่านต่อ' },
  ];
