...
@Component({
  selector: 'app-chaos-dwarfs',
  templateUrl: './chaos-dwarfs.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './chaos-dwarfs.component.scss',
  ],
})
export class ChaosDwarfsComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Chaos Dwarfs คือใคร?' },
