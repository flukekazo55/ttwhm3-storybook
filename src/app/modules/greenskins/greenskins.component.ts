...
@Component({
  selector: 'app-greenskins',
  templateUrl: './greenskins.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './greenskins.component.scss',
  ],
})
export class GreenskinsComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Greenskins คือใคร?' },
