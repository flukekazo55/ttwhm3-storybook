...
@Component({
  selector: 'app-bretonnia',
  templateUrl: './bretonnia.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './bretonnia.component.scss',
  ],
})
export class BretonniaComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Bretonnia คือใคร?' },
