...
@Component({
  selector: 'app-dark-elves',
  templateUrl: './dark-elves.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './dark-elves.component.scss',
  ],
})
export class DarkElvesComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Dark Elves คือใคร?' },
