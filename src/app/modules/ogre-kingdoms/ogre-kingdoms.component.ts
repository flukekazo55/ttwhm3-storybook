...
@Component({
  selector: 'app-ogre-kingdoms',
  templateUrl: './ogre-kingdoms.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './ogre-kingdoms.component.scss',
  ],
})
export class OgreKingdomsComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Ogre Kingdoms คือใคร?' },
