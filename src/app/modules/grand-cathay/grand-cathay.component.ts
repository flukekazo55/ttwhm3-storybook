...
@Component({
  selector: 'app-grand-cathay',
  templateUrl: './grand-cathay.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './grand-cathay.component.scss',
  ],
})
export class GrandCathayComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Grand Cathay คือใคร?' },
    { id: 'ch2', numeral: 'II', title: 'จักรวรรดิมังกรสวรรค์และ Great Bastion' },
    { id: 'ch3', numeral: 'III', title: 'เมืองและมณฑลสำคัญ' },
    { id: 'ch4', numeral: 'IV', title: 'Harmony, Yin–Yang และเวทมนตร์' },
    { id: 'ch5', numeral: 'V', title: 'Legendary Lords' },
    { id: 'ch6', numeral: 'VI', title: 'Ivory Road และกองคาราวาน' },
    { id: 'ch7', numeral: 'VII', title: 'กองทัพ Grand Cathay' },
    { id: 'ch8', numeral: 'VIII', title: 'เครื่องจักร สัตว์ศักดิ์สิทธิ์ และ Tiger Warriors' },
    { id: 'ch9', numeral: 'IX', title: 'Grand Cathay ใน WARHAMMER III ปี 2026' },
