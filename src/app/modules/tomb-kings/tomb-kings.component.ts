...
@Component({
  selector: 'app-tomb-kings',
  templateUrl: './tomb-kings.component.html',
  styleUrls: [
    '../../shared/styles/chronicle-book.scss',
    './tomb-kings.component.scss',
  ],
})
export class TombKingsComponent {
  readonly chapters: TocChapter[] = [
    { id: 'ch1', numeral: 'I', title: 'Tomb Kings คือใคร?' },
